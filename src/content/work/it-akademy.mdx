...
<div class="mb-6">
	<Tag name="symfony" label="Symfony" />
	<Tag name="docker" label="Docker" />
	<Tag name="zend" label="Zend" />
	<Tag name="ionic" label="Ionic" />
	<Tag name="vagrant" label="Vagrant" />
	<Tag name="angular" label="AngularJS" />
	<Tag name="mysql" label="MySQL" />
	<Tag name="laravel" label="Laravel" />
	<Tag name="architecture" label="Pédagogie" />
</div>
