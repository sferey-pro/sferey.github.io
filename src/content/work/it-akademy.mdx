...
<div class="mb-6">
	<Tag name={DevTags.SYMFONY}>Symfony</Tag>
	<Tag name={DevTags.DOCKER}>Docker</Tag>
	<Tag name={DevTags.ZEND}>Zend</Tag>
	<Tag name={DevTags.IONIC}>Ionic</Tag>
	<Tag name={DevTags.VAGRANT}>Vagrant</Tag>
	<Tag name={DevTags.ANGULAR}>AngularJS</Tag>
	<Tag name={DevTags.MYSQL}>MySQL</Tag>
	<Tag name={DevTags.LARAVEL}>Laravel</Tag>
	<Tag name={DevTags.ARCHITECTURE}>Pédagogie</Tag>
</div>
